...
const socialLinks = [
  {
    name: 'Twitter',
    href: 'https://twitter.com/neurogeneration',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/neurogeneration',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/neurogeneration',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/neurogeneration',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'YouTube',
    href: 'https://youtube.com/@neurogeneration',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link
                href="/privacy"
                className="text-gray-500 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 text-sm transition-colors"
              >
                Privacy Policy
              </Link>
              <Link
